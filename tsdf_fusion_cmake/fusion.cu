...
int fusion(int argc, char** argv) {
    ...
    float trunc_margin = voxel_size * 5; // truncation margin 截断边缘
    ...
    std::cout << "Creating surface point cloud use pcl formate..." << std::endl;
    ...
    VoxelGrid2PointCloud(voxel_grid_dim_x, voxel_grid_dim_y, voxel_grid_dim_z,
                         voxel_size, voxel_grid_origin_x, voxel_grid_origin_y, voxel_grid_origin_z,
                         voxel_grid_TSDF, voxel_grid_weight, 0.2f, 0.0f);
