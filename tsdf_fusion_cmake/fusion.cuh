...
#ifndef TSDF_FUSION_FUSION_CUH
#define TSDF_FUSION_FUSION_CUH


// Compute surface points from TSDF voxel grid and add points to pcl point cloud
void VoxelGrid2PointCloud(int voxel_grid_dim_x, int voxel_grid_dim_y, int voxel_grid_dim_z, float voxel_size,
    ...
    // Create point cloud content for pcl point cloud
